...
const report = {
  ...
  methodology:{
    ...
    stabilityRecheck:'when both cheap judges agree on dense rank 2, repeat Lite only with reversed candidate order; accept only the same original passage, otherwise fail closed to the smallest safe verifier tier (16, then 64)',
    provenanceDefinition:'provenance validates identity/integrity of the selected immutable record; semantic correctness is measured separately by retrieval accuracy',
