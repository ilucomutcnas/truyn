...
const report = {
  ...
  methodology:{
    ...
    verifierCandidateTiers:[16,64],
    stabilityRecheckDenseRanks:[2],
    stabilityRecheck:'repeat both cheap judges with reversed candidate order; accept only the same original passage, otherwise fail closed to verifier',
